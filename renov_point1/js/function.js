...
$(function () {
  ...
  // keyv
  // ---------------------------------------
  var $keyv_slides = $("#keyv").find(".slides");
  var allImage = $keyv_slides.find(".slide img");
  ...
  for (var i = 0; i < allImageCount; i++) {
    ...
    img.attr('src', allImage.attr('src'));
  }
  ...
  // 注意書きを開く
  // ---------------------------------------
  $('#form .form-attention h5, #fair .form-attention h5').click(function(){
