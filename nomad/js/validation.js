(function() {
  $('document').ready(function() {
    ...
    $submitBtn.on('click', function(e) {
      if (isValidAll) {
        var contactCompany = $('[name=contactCompany]').val();
        var contactName = $('[name=contactName]').val();
        var contactEmail = $('[name=contactEmail]').val();
        var contactPhoneNumber = $('[name=contactPhoneNumber]').val();
        var content = $('[name=content]').val();
        var free = $('[name=free]').val();
        localStorage.setItem("contactCompany", contactCompany);
